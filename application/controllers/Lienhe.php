...
class Lienhe extends CI_Controller
{
	...
	public function index()
	{
		...
		if ($this->form_validation->run() == TRUE && ($_SESSION['_token']==$_POST['_token'] )  ) {
			$mydata = array(
			...
			echo '<script>alert("Bạn cần nhập lại thông tin liên hệ!")</script>';	
		}
		$this->data['title'] = "Chau Dien Hasaki - Liên hệ";
