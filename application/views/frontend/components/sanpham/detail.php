					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<div class="product-view-content">
							...
							<div class="fk-boxs" id="km-all" data-comt="False">
								<div id="km-detail">
									<p class="fk-tit">Khuyến mại đặc biệt Khi mua hàng tại Chau Dien Hasiki</p>
									<div class="fk-main">
										<div class="fk-sales">
											</ul>
											<ul>
												<li>FreeShip với đơn hàng trên 500k</li>
											</ul>
											<ul>
												<li>Tặng mã giảm giá khi mua hàng trong tháng 11 <a href="#" target="_blank">Xem chi tiết</a>
												</li>
											</ul>
											<ul>
												<li>Tặng phiếu mua hàng cho lần mua tiếp theo <a href="#" target="_blank">Xem chi tiết</a>
												</li>
											</ul>
										</div>
									</div>
							...
							<div style="margin-top: 20px;">
								<b>Tình trạng</b>
								<br>
								<span>Cam kết cung cấp các sản phẩm chính hãng và nhập khẩu 100% từ Mỹ, Pháp… Số lượng sản phẩm và dịch vụ lớn nhất với chủng loại đa dạng, phong phú sẽ đáp ứng tất cả nhu cầu mua sắm của bạn.</span>
							</div>
							<div style="margin-top: 20px;">
								<b>Đổi trả</b>
								<br>
								<span>Cửa hàng nhận đổi trả sản phẩm cho khách hàng trong vòng 14 ngày, tính kể từ ngày khách hàng mua hoặc nhận được sản phẩm từ bên giao hàng.</span><a href="#" style="color:red"> (Chi tiết)</a>
							</div>
							<div style="margin-top: 20px;">
								<b>Hoàn tiền</b>
								<br>
								<span>Hoàn tiền 100% khi phát hiện hàng không chính hãng, không đúng với quảng cáo.</span>
							</div>
						</div>
					</div>
