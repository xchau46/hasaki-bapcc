	...
	<div class="container">
		<div class="col-md-7 col-12">
			<div class="section-article contactpage" style="  padding-left: 20px;">
				...
				<form accept-charset="UTF-8" action="<?php echo base_url() ?>lien-he" id="contact" method="post" enctype='multipart/form-data'>
					...
					<div class="form-comment">
						...
						<button type="submit" name="submit" value="upload" class="btn-update-order">Gửi nhận xét</button>
			...
			">
				...
				<ul class="list-unstyled">
					<li class="clearfix">
						...
						<span style="color: black"> 29 Lê Lợi, Phường 4, Gò Vấp, TP.HCM</span><br>
					</li>
					<li class="clearfix">
						<i class="fa fa-phone fa-1x" style="color:#0f9ed8;padding: 20px;  "></i>
						<span style="color: black">0862323084</span>
					</li>
					<li class="clearfix">
						<i class="fa fa-envelope fa-1x " style="color:#0f9ed8; padding: 20px; "></i>
						<span style="color: black"><a href="mailto:nxc0406@gmail.com">nxc0406@gmail.com</a></span>
					</li>
				</ul>
			</div>
