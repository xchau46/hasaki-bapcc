...
class Thongtin extends CI_Controller
{
    ...
    {
        $this->data['title'] = 'Cuong-Long Bookstore- Thông tin tài khoản';
    ...
    public function order()
    {
        ...
        $this->data['title'] = 'Cuong-Long Bookstore - Chi tiết đơn hàng';
    ...
    public function reset_password()
    {
        ...
        $this->data['title'] = 'Cuong-Long Bookstore - Đổi mật khẩu';
