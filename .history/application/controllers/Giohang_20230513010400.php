    ...
    public function info_order()
    {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if (isset($_POST['dathang'])) {
                ...
                $vnp_Returnurl = "https://localhost/project_codeign/thankyou.php";
                $vnp_TmnCode = "WFA7TJD5"; //Mã website tại VNPAY 
                $vnp_HashSecret = "PYMSCAXVQDTPNLVWVJNWPLYEGTXLALTO"; //Chuỗi bí mật

                $vnp_TxnRef = rand(0, 99); //Mã đơn hàng. Trong thực tế Merchant cần insert đơn hàng vào DB và gửi mã này sang VNPAY
