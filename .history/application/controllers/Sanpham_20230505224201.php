...
class Sanpham extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['title'] = 'Cuong-Long Bookstore - Tất cả sản phẩm';
    ...
    public function category()
    {
        ...
        $this->data['title'] = 'Cuong-Long Bookstore - Sản phẩm theo từng danh mục';
    ...
    public function detail($link)
    {
        ...
        $this->data['row'] = $row;
        $this->data['title'] = 'Cuong-Long Bookstore - ' . $row['name'];
