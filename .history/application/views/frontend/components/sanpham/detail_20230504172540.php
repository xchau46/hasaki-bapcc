					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<div class="product-view-content">
							...
							<div class="fk-boxs" id="km-all" data-comt="False">
								<div id="km-detail">
									<p class="fk-tit">Khuyến mại đặc biệt Khi mua hàng tại Cuong-Long Bookstore</p>
									<div class="fk-main">
										<div class="fk-sales">
											</ul>
											<ul>
												<li>FreeShip với đơn hàng trên 200k</li>
											</ul>
											<ul>
												<li>Tặng mã giảm giá khi mua hàng trong tháng 4 <a href="#" target="_blank">Xem chi tiết</a>
												</li>
											</ul>
											<ul>
							...
							<div style="margin-top: 20px;">
								<b>Tình trạng</b>
								<br>
								<span>Sản phẩm mới 100% được đóng gói cẩn thận trước khi giáo hàng. Cam kết 100% sách mới.</span>
							</div>
							<div style="margin-top: 20px;">
								<b>Đổi trả</b>
								<br>
								<span>Sản phẩm được đổi trả khi giao nhầm sản phẩm, lỗi từ bên phía người bán.</span><a href="#" style="color:red"> (Chi tiết)</a>
							</div>
							<div style="margin-top: 20px;">
								<b>Hoàn tiền</b>
								<br>
								<span>Hoàn tiền 100% khi phát hiện sách cũ, không đúng với quảng cáo.</span>
							</div>
						</div>
					</div>
