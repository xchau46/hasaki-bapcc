	...
	<section class="content-header">
		...
		<div class="breadcrumb">
			<a class="btn btn-primary btn-sm" href="admin/orders/recyclebin" role="button">
				<span class="glyphicon glyphicon-trash"></span> Đơn hàng đã lưu (<?php $total = $this->Morders->orders_trash_count();
																					echo $total; ?>)
			</a>
		</div>
	</section>
				...
				<div class="box" id="view">
					<div class="box-header with-border">
						...
						<div class="box-body">
							...
							<?php elseif ($val['status'] == 0 || $val['status'] == 5) : ?>
